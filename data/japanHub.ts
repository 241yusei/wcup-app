...
export const japanInfo: JapanInfo = {
  ...
  knockoutOutlook:
    "グループF2位で突破し、ラウンド32（6/29 HOU／NRGスタジアム）でブラジルと対戦（日本時間6/30早朝）。グループCを圧巻の3戦全勝・12得点1失点で制した本命ブラジルが相手。勝てばラウンド16はDAL（コットン・ボウル）で、おそらくグループ上位通過チームと対戦。ここを超えられればベスト8以上は現実的。PK戦では守護神の存在が鍵を握る。",
  watchTips: [
