...
export const news: NewsItem[] = [
  ...
  },
  {
    id: "20260629-jpnbra",
    category: "serious",
    title: "本日深夜！ブラジル vs 日本 ラウンド32でいよいよ開幕の大一番",
    summary:
      "6/29（JST未明）、ヒューストン・NRGスタジアムでラウンド32 ブラジル対日本が開催される。グループCを3戦全勝（7得点0失点）で首位通過したブラジルに対し、日本はグループFを2位で突破。カタール2022での伝説の「ドイツ・スペイン連破」を超える最大の難敵だが、森保ジャパンは「史上初のベスト8」へ向け全力を尽くす。グループ最終節でヴィニシウスが4得点・クーニャが3得点のブラジルは本大会屈指の攻撃力を誇る。",
    sourceName: "100倍Wカップ編集部",
    sourceUrl: "/schedule",
    date: "2026-06-29",
    tag: "日本代表",
