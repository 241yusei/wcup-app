...
export const news: NewsItem[] = [
  ...
  },
  {
    ...
    summary:
      "日本と同じグループFのもう1試合では、スウェーデンがチュニジアを5-1で撃破。ヤシン・アヤリが2得点、アレクサンデル・イサク（1ゴール2アシスト）、ヴィクトル・ヨケレスも得点し、途中出場のスバンベリは投入18秒で決めた。第1節を終えてグループFはスウェーデンが勝点3で首位、日本とオランダが勝点1、チュニジアが0。日本は第2戦でそのチュニジア（6/21・モンテレイ）と対戦する。ここで勝点3を取れば突破が大きく近づく。",
    sourceName: "ESPN",
  ...
  // ─── 大会1週目（6/16〜18）の最新結果＆日本第2戦プレビュー（ファクトチェック済み 2026-06-18）───
  {
    id: "20260618-jpn",
    category: "serious",
    title: "日本、第2戦チュニジアへ調整再開 久保建英は左ひざ負傷で別メニュー 6/21・日テレ生中継",
    summary:
      "日本代表は6/17、ナッシュビルで第2戦チュニジア戦（6/21 13:00・モンテレイ）へ向け調整を再開。初戦オランダ戦で左ひざを痛めた久保建英は試合参加を見送り、チームに帯同しながら治療で早期回復を目指す。司令塔の状態が最大の焦点に。中継は日本テレビが12:30から、解説は本田圭佑、現地スタジオに2018年W杯代表の槙野智章が入る。",
    sourceName: "サッカーキング",
    sourceUrl: "https://www.soccer-king.jp/news/japan/national/20260617/2173098.html",
    date: "2026-06-18",
    tag: "日本代表",
  },
  {
    id: "20260618-eng",
    category: "serious",
    title: "イングランドが4-2でクロアチアに快勝 ケイン2発でリネカーの英代表最多記録に並ぶ",
    summary:
      "6/17（日本時間18日）、ダラスでのグループL初戦でイングランドがクロアチアを4-2で下した。ハリー・ケインがPKを含む2得点を挙げ、W杯通算10ゴールでリネカーが持つ英代表最多記録に並んだ。後半開始直後にベリンガムが個人技で勝ち越し、終盤はラッシュフォードがダメ押し。打ち合いを制したトゥヘル体制のイングランドが好スタートを切った。",
    sourceName: "ESPN",
    sourceUrl: "https://www.espn.com/soccer/story/_/id/49099495/england-croatia-world-cup-2026-recap-score-harry-kane-jude-bellingham-marcus-rashford",
    date: "2026-06-18",
    tag: "海外選手",
  },
  {
    id: "20260618-fav",
    category: "serious",
    title: "優勝候補が続々始動 フランスがセネガルに3-1、アルゼンチンはアルジェリアに3-0",
    summary:
      "大会1週目、優勝候補がそろって白星発進。6/16にフランスがセネガルを3-1で退け、6/17にはアルゼンチンがアルジェリアを3-0で完封した。ノルウェーはイラクを4-1で破り、エースのハーランドを擁する28年ぶり出場組も好発進。一方ポルトガルはコンゴ民主共和国と1-1で引き分け、コンゴはW杯史上初の勝点1を手にした。",
    sourceName: "SBS News",
    sourceUrl: "https://www.sbs.com.au/news/article/fifa-world-cup-2026-results-june-18/bu88muv9e",
    date: "2026-06-18",
    tag: "大会情報",
  },
];
