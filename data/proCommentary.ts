...
export const gen = {
  ...
  intro:
    "よう。ボールネコのゲンだ。普段は画面の右下で寝てるが、サッカーの話となりゃ黙っちゃいられねえ。にわか向けの優しい解説は他のページに任せて、ここじゃ本音で言う。『そこまで言うか』と思ったら、お前さんも玄人の入り口に立ったってことだ。",
  tldr: [
...
export const proSections: ProSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "全部、俺の見立てだ。外れたら笑ってくれ。当たったら……『ゲンの言った通りだろ』とだけ言ってくれりゃいい。じゃあな。試合、楽しめよ。",
    ],
  },
];
