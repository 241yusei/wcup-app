...
export const matchPreviews: MatchPreview[] = [
  ...
  },
  {
    teamA: "JPN",
    teamB: "TUN",
    h2h: "日本から見て通算4勝0分1敗。W杯では2002年日韓大会GL最終戦で2-0勝利し、決勝トーナメント進出を決めた縁起の良い相手。ただし2022年キリンカップ決勝（吹田）では0-3で完敗しており油断は禁物（直近2023年は2-0で雪辱）。",
    formA: "A代表6連勝中（ブラジル〜アイスランドまで）。",
    formB:
      "直近5試合で1勝のみ（得点5・失点5）と低調。2026年1月のアフリカ選手権でタンザニア・マリと引き分け。",
    asOf: "2026年5月末時点のデータ・招集は報道ベース",
    highlights: [
      "日本が通算4勝1敗と分の良い相手。2002年W杯で決勝T進出を決めた縁起の良いカード。ただし2022年には0-3完敗の苦い記憶も。",
    ...
    mustKnow: {
      point: {
        normal:
          "日本が通算4勝1敗と分の良い相手。3戦で最も勝ち点を計算したい大事な一戦。ただし2022年に0-3で負けた記憶も新しい。",
        simple: "日本が得意にしてきた相手。ただ4年前に一度ボコッと負けてるので、油断は禁物の試合。",
      },
      player: {
        normal:
