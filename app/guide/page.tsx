...
export const metadata = {
  ...
  description:
    "サッカーをよく知らなくても大丈夫。2026ワールドカップの基本ルール・観戦のコツ・推し国の見つけ方を、にわかさん目線でやさしく解説。",
};
...
const rules = [
  ...
  },
  {
    icon: "🏆",
    title: "決勝トーナメント",
    body: "各組の上位がベスト32へ進み、ここから先は一発勝負。引き分けなら延長戦、それでも決まらなければPK戦で勝者を決める。負けたら終わりの緊張感が魅力。",
  },
];
    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <header className="mb-8 flex items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold mb-1">W杯を100倍楽しむ入門</h1>
